...
<div class="date-banner" style="color:rgb(226 150 76);">2021/02/23 - 2021/03/16</div>
<h3><div class ="title-banner">Epitome Invocation - Staff of Homa, Wolf's Gravestone (&#9733;&#9733;&#9733;&#9733;&#9733;), Lithic Blade, etc. (&#9733;&#9733;&#9733;&#9733;)</div></h3>
<img src="../../images/banner/wolf staff 1.3.jpg" alt="Epitome Invocation" class="center">
<?php
    require_once "database/connect.php";
    require_once "archive/epitome_invocation_8/wish_weapon.php";
    require_once "archive/epitome_invocation_8/detail.php";
?>
    ...
    if(isset($_POST["weapon"])){
        ...
        <table style="width:100%;text-align:center;">
            ...
            <tr>
            <th colspan="7" class="seehistory" style="border:0px;"><a href="https://genshin-impact.fandom.com/wiki/Epitome_Invocation/2021-02-23" target="_blank">See Detail in Wiki Page</a></th>
            </tr>
        </table>
        <?php
        }
