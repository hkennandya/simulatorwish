<div class="event-banner" style="color:rgb(240 117 81);"><i>&#10022; Character Event Wish</i></div>
<div class="date-banner" style="color:rgb(240 117 81);">2021/01/12 - 2021/02/02</div>
<h3><div class ="title-banner">Moment of Bloom - Hu Tao (&#9733;&#9733;&#9733;&#9733;&#9733;), Xingqiu, Xiangling, Chongyun (&#9733;&#9733;&#9733;&#9733;)</div></h3>
<img src="../../images/banner/hu_tao 1.3.jpg" alt="Moment of Bloom" class="center">

<?php
    require_once "database/connect.php";
    require_once "archive/moment_of_bloom/wish_character.php";
    require_once "archive/moment_of_bloom/detail.php";
?>
    ...
    if(isset($_POST["chara"])){
        ...
        <table style="width:100%;text-align:center;">
            ...
            <tr>
            <th colspan="4" class="seehistory" style="border:0px;"><a href="https://genshin-impact.fandom.com/wiki/Moment_of_Bloom" target="_blank">See Detail in Wiki Page</a></th>
            </tr>
        </table>
        <?php
    }
