...
<div class="date-banner" style="color:rgb(226 150 76);">2020/12/01 - 2020/12/22</div>
<h3><div class ="title-banner">Epitome Invocation - Vortex Vanquisher, The Unforged (&#9733;&#9733;&#9733;&#9733;&#9733;), The Bell etc. (&#9733;&#9733;&#9733;&#9733;)</div></h3>
<img src="../../images/banner/vortex the 1.1.jpg" alt="Epitome Invocation" class="center">
<?php
    require_once "database/connect.php";
    require_once "archive/epitome_invocation_4/wish_weapon.php";
    require_once "archive/epitome_invocation_4/detail.php";
?>
    ...
    if(isset($_POST["weapon"])){
        ...
        <table style="width:100%;text-align:center;">
            ...
            <tr>
            <th colspan="7" class="seehistory" style="border:0px;"><a href="https://genshin-impact.fandom.com/wiki/Epitome_Invocation/2020-12-01" target="_blank">See Detail in Wiki Page</a></th>
            </tr>
        </table>
        <?php
        }
