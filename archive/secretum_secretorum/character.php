...
<div class="date-banner" style="color:rgb(198 157 105);">2020/12/23 - 2021/01/12</div>
<h3><div class ="title-banner">Secretum Secretorum - Albedo (&#9733;&#9733;&#9733;&#9733;&#9733;), Fischl, Sucrose, Bennett (&#9733;&#9733;&#9733;&#9733;)</div></h3>
<img src="../../images/banner/albedo 1.2.jpg" alt="Secretum Secretorum" class="center">

<?php
    require_once "database/connect.php";
    require_once "archive/secretum_secretorum/wish_character.php";
    require_once "archive/secretum_secretorum/detail.php";
?>
    ...
    if(isset($_POST["chara"])){
        ...
        <table style="width:100%;text-align:center;">
            ...
            <tr>
            <th colspan="4" class="seehistory" style="border:0px;"><a href="https://genshin-impact.fandom.com/wiki/Secretum_Secretorum" target="_blank">See Detail in Wiki Page</a></th>
            </tr>
        </table>
        <?php
    }
