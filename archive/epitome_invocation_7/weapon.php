...
<div class="date-banner" style="color:rgb(226 150 76);">2021/02/03 - 2021/02/23</div>
<h3><div class ="title-banner">Epitome Invocation - Primordial Jade Winged-Spear, Primordial Jade Cutter (&#9733;&#9733;&#9733;&#9733;&#9733;), Eye of Perception, etc. (&#9733;&#9733;&#9733;&#9733;)</div></h3>
<img src="../../images/banner/primordial primordial 1.3.jpg" alt="Epitome Invocation" class="center">
<?php
    require_once "database/connect.php";
    require_once "archive/epitome_invocation_7/wish_weapon.php";
    require_once "archive/epitome_invocation_7/detail.php";
?>
    ...
    if(isset($_POST["weapon"])){
        ...
        <table style="width:100%;text-align:center;">
            ...
            <tr>
            <th colspan="7" class="seehistory" style="border:0px;"><a href="https://genshin-impact.fandom.com/wiki/Epitome_Invocation/2021-02-03" target="_blank">See Detail in Wiki Page</a></th>
            </tr>
        </table>
        <?php
        }
