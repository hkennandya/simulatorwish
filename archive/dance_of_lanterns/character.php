<div class="event-banner" style="color:rgb(127 111 197);"><i>&#10022; Character Event Wish</i></div>
<div class="date-banner" style="color:rgb(127 111 197);">2021/02/17 - 2021/03/02</div>
<h3><div class ="title-banner">Dance of Lanterns - Keqing (&#9733;&#9733;&#9733;&#9733;&#9733;), Bennett, Ningguang, Barbara (&#9733;&#9733;&#9733;&#9733;)</div></h3>
<img src="../../images/banner/keqing 1.3.jpg" alt="Dance of Lanterns" class="center">

<?php
    require_once "database/connect.php";
    require_once "archive/dance_of_lanterns/wish_character.php";
    require_once "archive/dance_of_lanterns/detail.php";
?>
    ...
    if(isset($_POST["chara"])){
        ...
        <table style="width:100%;text-align:center;">
            ...
            <tr>
            <th colspan="4" class="seehistory" style="border:0px;"><a href="https://genshin-impact.fandom.com/wiki/Dance_of_Lanterns" target="_blank">See Detail in Wiki Page</a></th>
            </tr>
        </table>
        <?php
    }
