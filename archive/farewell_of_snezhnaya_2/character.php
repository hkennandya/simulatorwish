...
<div class="date-banner" style="color:rgb(67 147 178);">2021/04/06 - 2021/04/27</div>
<h3><div class ="title-banner">Farewell of Snezhnaya - Tartaglia (&#9733;&#9733;&#9733;&#9733;&#9733;), Rosaria, Barbara, Fischl (&#9733;&#9733;&#9733;&#9733;)</div></h3>
<img src="../../images/banner/tartaglia 1.4.png" alt="Farewell of Snezhnaya" class="center">
<?php
    require_once "database/connect.php";
    require_once "archive/farewell_of_snezhnaya_2/wish_character.php";
    require_once "archive/farewell_of_snezhnaya_2/detail.php";
?>
    ...
    if(isset($_POST["chara"])){
        ...
        <table style="width:100%;text-align:center;">
            ...
            <tr>
            <th colspan="4" class="seehistory" style="border:0px;"><a href="https://genshin-impact.fandom.com/wiki/Farewell_of_Snezhnaya/2021-04-06" target="_blank">See Detail in Wiki Page</a></th>
            </tr>
        </table>
        <?php
    }
