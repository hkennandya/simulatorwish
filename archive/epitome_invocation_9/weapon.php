...
<div class="date-banner" style="color:rgb(226 150 76);">2021/03/17 - 2021/04/06</div>
<h3><div class ="title-banner">Epitome Invocation - Elegy for the End, Skyward Blade (&#9733;&#9733;&#9733;&#9733;&#9733;), The Alley Flash etc. (&#9733;&#9733;&#9733;&#9733;)</div></h3>
<img src="../../images/banner/elegy alley 1.4.jpg" alt="Epitome Invocation" class="center">
<?php
    require_once "database/connect.php";
    require_once "archive/epitome_invocation_9/wish_weapon.php";
    require_once "archive/epitome_invocation_9/detail.php";
?>
    ...
    if(isset($_POST["weapon"])){
        ...
        <table style="width:100%;text-align:center;">
            ...
            <tr>
            <th colspan="7" class="seehistory" style="border:0px;"><a href="https://genshin-impact.fandom.com/wiki/Epitome_Invocation/2021-03-17" target="_blank">See Detail in Wiki Page</a></th>
            </tr>
        </table>
        <?php
        }
