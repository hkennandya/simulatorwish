<div class="event-banner" style="color:rgb(198 157 105);"><i>&#10022; Character Event Wish</i></div>
<div class="date-banner" style="color:rgb(198 157 105);">2020/12/01 - 2020/12/22</div>
<h3><div class ="title-banner">Gentry of Hermitage - Zhongli (&#9733;&#9733;&#9733;&#9733;&#9733;), Razor, Chongyun, Xinyan (&#9733;&#9733;&#9733;&#9733;)</div></h3>
<img src="../../images/banner/zhongli 1.1.png" alt="Gentry of Hermitage" class="center">

<?php
    require_once "database/connect.php";
    require_once "archive/gentry_of_hermitage/wish_character.php";
    require_once "archive/gentry_of_hermitage/detail.php";
?>
    ...
    if(isset($_POST["chara"])){
        ...
        <table style="width:100%;text-align:center;">
            ...
            <tr>
            <th colspan="4" class="seehistory" style="border:0px;"><a href="https://genshin-impact.fandom.com/wiki/Gentry_of_Hermitage" target="_blank">See Detail in Wiki Page</a></th>
            </tr>
        </table>
        <?php
    }
