...
<div class="date-banner" style="color:rgb(226 150 76);">2021/04/06 - 2021/04/27</div>
<h3><div class ="title-banner">Epitome Invocation - Skyward Harp, Lost Prayer to the Sacred Winds (&#9733;&#9733;&#9733;&#9733;&#9733;), Alley Hunter etc. (&#9733;&#9733;&#9733;&#9733;)</div></h3>
<img src="../../images/banner/skyward lost 1.4.png" alt="Epitome Invocation" class="center">
<?php
    require_once "database/connect.php";
    require_once "archive/epitome_invocation_10/wish_weapon.php";
    require_once "archive/epitome_invocation_10/detail.php";
?>
    ...
    if(isset($_POST["weapon"])){
        ...
        <table style="width:100%;text-align:center;">
            ...
            <tr>
            <th colspan="7" class="seehistory" style="border:0px;"><a href="https://genshin-impact.fandom.com/wiki/Epitome_Invocation/2021-04-06" target="_blank">See Detail in Wiki Page</a></th>
            </tr>
        </table>
        <?php
        }
