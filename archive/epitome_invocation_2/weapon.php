...
<div class="date-banner" style="color:rgb(226 150 76);">2020/10/20 - 2020/11/09</div>
<h3><div class ="title-banner">Epitome Invocation - Lost Prayer to the Sacred Winds, Wolf's Gravestone (&#9733;&#9733;&#9733;&#9733;&#9733;), Sacrificial Greatsword and more (&#9733;&#9733;&#9733;&#9733;)</div></h3>
<img src="../../images/banner/lost wolf 1.0.jpg" alt="Epitome Invocation" class="center">
<?php
    require_once "database/connect.php";
    require_once "archive/epitome_invocation_2/wish_weapon.php";
    require_once "archive/epitome_invocation_2/detail.php";
?>
    ...
    if(isset($_POST["weapon"])){
        ...
        <table style="width:100%;text-align:center;">
            ...
            <tr>
            <th colspan="7" class="seehistory" style="border:0px;"><a href="https://genshin-impact.fandom.com/wiki/Epitome_Invocation/2020-10-20" target="_blank">See Detail in Wiki Page</a></th>
            </tr>
        </table>
        <?php
        }
