...
<meta name="viewport" content="width=device-width, initial-scale=1.0,maximum-scale=1.0,user-scalable=0">
    ...
    <meta name="description" content="Simulation of wish or gacha from game Genshin Impact">    <title>History Beginners Wish - Simulator Wish Genshin Impact</title>
...
<body id="top">
    ...
    <p><button type = "submit" class="button">Back</button>
            ...
            <?php
                ...
                $sql = "SELECT * FROM history_beginners WHERE id=$user_id ORDER BY roll DESC";
